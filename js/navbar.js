...
<nav class="bg-blue-600 text-white shadow-lg">
    <div class="container mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <!-- Menü gombok -->
        <div id="menu-links" class="overflow-hidden max-h-0 md:max-h-none transition-all duration-500 ease-in-out md:flex md:space-x-4 flex-col md:flex-row mt-4 md:mt-0">
